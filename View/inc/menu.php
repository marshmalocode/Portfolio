<div class="nav">
    <nav class="navi">
        <ul class="menu" onclick="toggle();">
            <li class="titreMenu"><a href="?z=accueil">Accueil</a></li>
            <li class="titreMenu"><a href="?z=trav">Travaux</a></li>
            <li class="titreMenu"><a href="?z=cv">CV</a></li>
